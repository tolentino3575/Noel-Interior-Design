...
add_action('wp_enqueue_scripts', function (){
    ...
    wp_register_style('fancybox', get_template_directory_uri() . '/src/fancybox/source/jquery.fancybox.css');
    wp_register_style('app', get_template_directory_uri() . '/web/stylesheets/app.css', ['slick-css', 'slick-theme-css']);
